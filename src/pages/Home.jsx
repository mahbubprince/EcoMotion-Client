...
const Home = () => {
  ...
  return (
    <div className="mt-16">
      ...
      {/* 🌟 HERO / BANNER SECTION */}
      {/* =============================== */}
      <section className="relative h-[85vh] bg-gradient-to-br from-green-300 via-green-500 to-green-700 text-white flex flex-col justify-center items-center text-center px-6 overflow-hidden">
        ...
        >
          <Link
            to="/upcoming"
            className="bg-white text-green-700 font-bold px-10 py-4 rounded-full shadow-xl hover:bg-gray-100 hover:scale-105 transition-all text-lg"
      ...
      <section className="py-20 bg-green-700 text-white px-6">
        <h2 className="text-4xl font-bold text-center mb-6">
          Stay Updated with EcoMotion
        </h2>

        <p className="text-center opacity-90 mb-10 max-w-2xl mx-auto">
          Subscribe for weekly updates about upcoming events, new campaigns, and
        ...
        <div className="max-w-xl mx-auto flex flex-col md:flex-row gap-4">
          <input
            type="email"
            placeholder="Enter your email"
            className="px-5 py-4 rounded-full text-gray-800 flex-1 focus:outline-none focus:ring-4 focus:ring-green-300"
          />
          <button className="bg-white text-green-700 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all shadow-xl">
            Subscribe
          </button>
        </div>
      </section>
