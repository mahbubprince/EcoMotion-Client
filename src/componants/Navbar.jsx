...
//               <Link
//                 to="/login"
//                 className="bg-linear-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white px-5 py-2 rounded-xl shadow-md hover:shadow-lg transition-all font-semibold"
//               >
//                 Login
//               </Link>
//             ) : (
